...
#Merge two cohorts by 269 BCs and 748 TWBs
/work/opt/ohpc/T
aiwania3/pkg/biology/BCFtools/bcftools_v1.18/bin/bcftools merge \
...
/work/opt/ohpc/Taiwania3/pkg/biology/BCFtools/bcftools_v1.18/bin/bcftools view \
     ...
     -Oz /staging/biology/elephant123/269_bc_and_748_TWB/filter_call_ratet_by_270_BC_and_748_TWB.vcf.gz \
     -o /staging/biology/elephant123/269_bc_and_748_TWB/filtered_confidence_regions_by_270_BC_and_748_TWB.vcf.gz \
     --threads 112
 /work/opt/ohpc/Taiwania3/pkg/biology/BCFtools/bcftools_v1.18/bin/bcftools index -t -f \
    /staging/biology/elephant123/269_bc_and_748_TWB/filtered_confidence_regions_by_270_BC_and_748_TWB.vcf.gz --threads 112
 ...
 /work/opt/ohpc/Taiwania3/pkg/biology/BCFtools/bcftools_v1.18/bin/bcftools norm \
     ...
     -Oz /staging/biology/elephant123/269_bc_and_748_TWB/filtered_confidence_regions_by_270_BC_and_748_TWB.vcf.gz  \
     -o /staging/biology/elephant123/269_bc_and_748_TWB/split_and_left-align_multi-allelic_variant_by_270_BC_and_748_TWB.vcf.gz \
     --threads 112

 # 3. Index the normalized VCF
 /work/opt/ohpc/Taiwania3/pkg/biology/BCFtools/bcftools_v1.18/bin/bcftools index -t -f \
    /staging/biology/elephant123/269_bc_and_748_TWB/split_and_left-align_multi-allelic_variant_by_270_BC_and_748_TWB.vcf.gz \
     --threads 112

 # 4. Filter by call rate > 98%
 /work/opt/ohpc/Taiwania3/pkg/biology/BCFtools/bcftools_v1.18/bin/bcftools view \
     -i 'F_MISSING < 0.02' \
     -Oz /staging/biology/elephant123/269_bc_and_748_TWB/split_and_left-align_multi-allelic_variant_by_270_BC_and_748_TWB.vcf.gz \
     -o /staging/biology/elephant123/269_bc_and_748_TWB/filter_call_ratet_by_270_BC_and_748_TWB.vcf.gz \
     --threads 112
...
#python3 /staging/biology/elephant123/269_bc_and_748_TWB/phase_in_our_data.py
