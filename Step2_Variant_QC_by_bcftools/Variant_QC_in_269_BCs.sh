...
/work/opt/ohpc/Taiwania3/pkg/biology/BCFtools/bcftools_v1.18/bin/bcftools view \
    ...
    -Oz /staging/biology/elephant123/269_BC_GVCF.vcf.gz \
    -o /staging/biology/elephant123/filtered_confidence_regions_by_270_BC_in_IGG.vcf.gz \
    --threads 112
/work/opt/ohpc/Taiwania3/pkg/biology/BCFtools/bcftools_v1.18/bin/bcftools index -t -f \
   /staging/biology/elephant123/filtered_confidence_regions_by_270_BC_in_IGG.vcf.gz --threads 112
...
/work/opt/ohpc/Taiwania3/pkg/biology/BCFtools/bcftools_v1.18/bin/bcftools norm \
    ...
    -o /staging/biology/elephant123/split_and_left-align_multi-allelic_variant_by_270_BC_in_IGG.vcf.gz \
    --threads 112

# 3. Index the normalized VCF
/work/opt/ohpc/Taiwania3/pkg/biology/BCFtools/bcftools_v1.18/bin/bcftools index -t -f \
   /staging/biology/elephant123/split_and_left-align_multi-allelic_variant_by_270_BC_in_IGG.vcf.gz --threads 112
# 4. Filter by call rate > 95%
/work/opt/ohpc/Taiwania3/pkg/biology/BCFtools/bcftools_v1.18/bin/bcftools view \
   -i 'F_MISSING < 0.02' \
   -Oz /staging/biology/elephant123/split_and_left-align_multi-allelic_variant_by_270_BC_in_IGG.vcf.gz \
   -o /staging/biology/elephant123/269_bc_and_748_TWB/filter_call_ratet_by_270_BC.vcf.gz  \
   --threads 112

# 5. Index the filtered VCF
/work/opt/ohpc/Taiwania3/pkg/biology/BCFtools/bcftools_v1.18/bin/bcftools index -t -f \
    /staging/biology/elephant123/269_bc_and_748_TWB/filter_call_ratet_by_270_BC.vcf.gz  --threads 112
